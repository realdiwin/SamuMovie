...
//        action = argmax_ap_f ( prg, image );
    ...
    double alpha ( int n ) {
        ...
        //return 10000.0/ ( ( ( double ) n ) + 10001.0 );
        //return 70.0/ ( ( ( double ) n ) + 80 ); // ~ 4600
        //return 1000000.0/ ( ( ( double ) n ) + 700001.0 );
    }
...
private:
    ...
    */
    ...
    /*
    // ~4600-hoz
    double max_reward { 900.20};
    double min_reward {-100.70};
    */
    double max_reward { 1000.20};
    double min_reward {-1000.70};
